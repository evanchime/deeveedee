...
const {getCompletion,createAssistant,createThread} = require("./services/openAI/getCompletionCopy") 
    ...
    if (
      ...
      try {
        ...
        if (!fromExists) {
          ...
          // Set the from phone number property in the session data
          sessData.from = from

          // Serialize object and set expiration time to 1 hour
          await redisClient.set(from, JSON.stringify(sessData), 'EX', 60*10); 
