    ...
    items: z
        .array(
            z.object({
                ...
                amount: z.object({
                  offset: z.number().describe("Must be 100"),
                  value: z.number().describe("The price per item in the order multiplied by 100. It should be a positive integer."),
                ...
                quantity: z.number().describe("The number of this item in the order, this field cannot be decimal has to be integer."),
            })
